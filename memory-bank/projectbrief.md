...
## Empresa
Nexova Solutions es una consultora de talento con operaciones en seleccion, soporte externalizado y formacion corporativa. El proyecto integra procesos operativos y datos en un monorepo para evolucionar aplicaciones y automatizaciones con IA.
...
## Alcance actual
- Web corporativa moderna en `uis/website`.
- Backoffice interno en `uis/backoffice`.
- Servicios backend bajo `services/`.
- Gobernanza AI-ready con `AGENTS.md`, `.agents/` y `memory-bank/`.
